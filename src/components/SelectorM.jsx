    ...
    return (
        <div className='flex flex-col select-none'>
            <div className='px-2 pt-2 pb-1 overflow-hidden' style={{ width: '196px' }}>
                <div className='flex'>
                    <div className='flex-1 pl-2 pr-5 hover:bg-gray-100 cursor-pointer'>{month}</div>
                    <div className='flex'>
                        <div className='flex justify-center items-center cursor-pointer hover:bg-gray-100' style={{ width: '28px', height: '28px' }}>
                ...
                <div>
                    <div className='mt-1' role='grid'>
                        <div className='mb-2' role='row'>
                            ...
                            <div className='mr-1 text-xs text-center inline-block cursor-pointer hover:bg-gray-100' role='gridcell' style={{ width: '40px', height: '40px', lineHeight: '40px' }}>4 月</div>
                        </div>
                        <div className='mb-2' role='row'>
